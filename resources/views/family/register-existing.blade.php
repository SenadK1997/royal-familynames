...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-6" action="{{ route('familyRegistrationExisting', ['family_code' => $family->family_code ]) }}" method="POST">
        @csrf
        <div>
        ...
        <div>
          ...
          <div class="mt-2">
            <input id="valuation" name="valuation" type="number" autocomplete="current-password" required class="px-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 dark:bg-gray-100">
          </div>
        </div>
