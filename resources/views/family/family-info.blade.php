    ...
    <div class="relative isolate overflow-hidden pt-16">
      <header class="pb-4 pt-6 sm:pb-6">
        <div class="mx-auto flex max-w-7xl flex-wrap items-center gap-6 px-4 sm:flex-nowrap sm:px-6 lg:px-8">
          <h1 class="text-base font-semibold leading-7 text-gray-900">Sort by</h1>
          <div class="order-last flex w-full gap-x-8 text-sm font-semibold leading-6 sm:order-none sm:w-auto sm:border-l sm:border-gray-200 sm:pl-6 sm:leading-7">
            <a href="#" class="text-indigo-600">Recent donators</a>
            <a href="#" class="text-gray-700">Highest donators</a>
            <a href="#" class="text-gray-700">All-time</a>
          </div>
          <a href="{{ route('support.family', ['family_code' => $family->family_code])}}" class="ml-auto flex items-center gap-x-1 rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
      ...
      <!-- Stats -->
      {{-- @php
          $sortedSupporters = $users->sortByDesc('pivot.supported_amount')->take(3);
      @endphp --}}
      @php
        $test = 0;
        @endphp
      ...
      <div class="border-b border-b-gray-900/10 lg:border-t lg:border-t-gray-900/5">
        <dl class="mx-auto grid max-w-7xl grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 lg:px-2 xl:px-0">
            <div class="flex items-baseline flex-wrap justify-between gap-y-2 gap-x-4 border-t border-gray-900/5 px-4 py-10 sm:px-6 lg:border-t-0 xl:px-8">
                <dt class="text-sm font-medium leading-6 text-gray-500">Total valuation</dt>
                <dd class="w-full flex-none text-3xl text-green-600 font-medium leading-10 tracking-tight text-gray-900">{{ $family->valuation }}.00 $</dd>
            </div>
            @foreach ($users->sortByDesc('pivot.supported_amount')->take(3) as $index => $supporter)
                <div class="flex items-baseline flex-wrap justify-between gap-y-2 gap-x-4 border-t border-gray-900/5 px-4 py-10 sm:px-6 lg:border-t-0 xl:px-8">
                    <dt class="text-sm font-medium leading-6 text-gray-500">{{ $supporter->name }}</dt>
    ...
    <div class="space-y-16 py-16 xl:space-y-20">
      ...
      <div>
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 class="mx-auto max-w-2xl font-semibold leading-6 text-gray-900 lg:mx-0 lg:max-w-none text-2xl text-zinc-500">{{ $family->family_name }}'s family</h2>
        </div>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="py-5 text-right">
                      <div class="flex justify-end">
                        <button type="button" class="text-sm font-medium leading-6 text-indigo-600 hover:text-indigo-500">View {{ $user->name }} Quote</button>
                      </div>
                    </td>
                  </tr>
                  @endforeach
                  ...
                  @foreach ($supporters as $supporter)
                    <tr>
                      ...
                      <td class="py-5 text-right">
                        <div class="flex justify-end">
                          <button type="button" class="text-sm font-medium leading-6 text-indigo-600 hover:text-indigo-500">View {{ $supporter->name }} Quote</button>
                        </div>
                      </td>
                    </tr>
                  @endforeach
