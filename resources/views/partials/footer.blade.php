<footer class="bg-white">
    <div class="mx-auto max-w-7xl px-6 py-12 max-h-[80px] md:flex md:items-center md:justify-between lg:px-8">
      <div class="flex justify-center space-x-6 md:order-2">
        ...
        <a href="https://github.com/SenadK1997" target="_blank" class="text-gray-400 hover:text-gray-500">
        ...
        <a href="https://www.youtube.com/watch?v=Rvi1d5a3Oc8" class="text-gray-400 hover:text-gray-500" target="_blank">
      ...
      <div class="mt-8 md:order-1 md:mt-0">
        <p class="text-center text-xs leading-5 text-gray-500">&copy; 2023 Senad Kurtovic, All rights reserved.</p>
      </div>
    </div>
  </footer>
